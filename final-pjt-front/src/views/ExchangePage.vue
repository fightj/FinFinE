  ...
  <div class="homebackcolor">
    <v-container align="center">
      ...
      <v-form>
        ...
        <!-- 금액 입력 -->
        <v-col cols="5">
          <v-text-field class="custom-text-field" v-model="exchangeBefore" :label="exchangeDetail.cur_unit" @input="validateInput"></v-text-field>
        </v-col>
...
.header-text {
  font-weight: bold;
  background: linear-gradient(180deg, rgba(255, 255, 255, 0) 55%, lighten(#6681a5, 35%) 50%);
  padding: 10px;
  border-radius: 8px;
  width: fit-content;
  margin-bottom: 50px;
