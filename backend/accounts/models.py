...
from fin_api.models import SavingProduct
from fin_api.models import DepositProduct
...
class User(AbstractUser):
    ...
    salary = models.IntegerField(default=0) # 봉급
    wealth = models.IntegerField(default=0) # 재산
